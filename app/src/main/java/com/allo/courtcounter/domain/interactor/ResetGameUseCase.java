...
public class ResetGameUseCase extends UseCase<Game, ResetGameUseCase.Params> {

    private GameRepository mGameRepository;

    @Inject
    public ResetGameUseCase(@ExecutorThread Scheduler threadExecutor,
    ...
    protected Observable<Game> buildUseCaseObservable(Params params) {
        return mGameRepository.resetGame(params.getGameId()).toObservable();
    }
